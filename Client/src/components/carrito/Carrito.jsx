...
function Carrito() {
  ...
  return (
    <div>
      <div
        // className={` absolute top-1/2 ${" md:right-5"} transform -translate-y-1/2`}

        className={` cart-container absolute top-1/2 ${" md:right-5"} transform -translate-y-1/2`}
      >
        <label
          tabIndex={0}
        ...
        <div className="mt-96 card max-h-96 overflow-auto card-compact dropdown-menu w-64 bg-base-100  shadow hidden peer-hover:flex hover:flex">
