...
const Footer = () => {
  return (
    <div>
      <footer className="footer  md:bottom-40 md:justify-center p-10 w-screen bg-gray-100 text-gray-600 mt-50">
        <div className="w-screen flex flex-col justify-evenly items-center md:items-center md:flex-row  ">
