...
function UserManagement() {
    ...
    return (
        <table className="table table-zebra text-center mt-[15%] w-[70%] mx-auto border border-black">
            <thead>
                <tr>
                    <th className="text-center">
                        ID{" "}
                        <svg onClick={handleSortBy} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 inline-block align-text-bottom cursor-pointer">
