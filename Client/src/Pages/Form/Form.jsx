            ...
            {sizes.map(({ size }) => (
                ...
                {categories.map((categorie, index) => (
                    ...
                    {form.categories.map((categories, index) => (
                        <button onClick={ () => handleDelete(index)} type="button" key={index}>{categories} X</button>
                        ))}
                        </div>
                    ...
                    {colors.map((color) => (
                        ...
                        {form.color.map((color, index) => (
                            <button onClick={ () => handleColorDelete(index)} type="button" key={index}>{color} X</button>
                            ))}
                    ...
                    {renderInputImg()}
                    <button onClick={addInputImg} value={form.images} type="button" >Agregar img</button>
                    <button onClick={lastInputImg} type="button" >Restar img</button>
